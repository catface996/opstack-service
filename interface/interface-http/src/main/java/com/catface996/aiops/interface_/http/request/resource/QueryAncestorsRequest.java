 ...
 * 查询资源祖先链请求
 *
 * <p>用于 POST /resources/ancestors/query 接口</p>
 *
 * <p>需求追溯：</p>
 * <ul>
 *   <li>Feature 024: POST-Only API 重构</li>
 *   <li>原接口: GET /resources/{id}/ancestors</li>
 * </ul>
 *
 * @author AI Assistant
 * @since 2025-12-22
 */
@Schema(description = "查询资源祖先链请求")
public class QueryAncestorsRequest {
    ...
    public QueryAncestorsRequest() {
    }

    public QueryAncestorsRequest(Long resourceId) {
