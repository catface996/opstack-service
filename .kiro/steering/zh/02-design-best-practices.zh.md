...
| 阶段 | 重点 | 输出物 | 门控 |
|------|------|--------|------|
| Phase -1 | 前置检查 | 上下文摘要 | ✅ 必须通过 |
| 第一步 | 理解和分析需求 | 需求理解确认 | ✅ 用户确认 |
| 第二步 | 概要设计 | 架构图、技术栈、ADR | ✅ 用户确认 |
| 第三步 | 详细设计 | 接口定义、数据结构、流程图 | ✅ 设计完成 |
| 第四步 | 输出设计文档 | plan.md | ✅ 文档已输出 |
| 第五步 | 设计验证（自检） | 验证报告 | ✅ 自检完成 |
| 第六步 | 用户确认和迭代 | 最终设计方案 | ✅ 用户认可 |
