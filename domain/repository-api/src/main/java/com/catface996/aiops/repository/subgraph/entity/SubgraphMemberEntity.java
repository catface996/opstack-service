 ...
 * @since 2025-12-22
 */
public class SubgraphMemberEntity {
    ...
    public SubgraphMemberEntity() {
    }

    public SubgraphMemberEntity(Long subgraphId, Long memberId, Long addedBy) {
