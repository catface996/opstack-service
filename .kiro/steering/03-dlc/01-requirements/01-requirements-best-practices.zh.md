...
| 阶段1 | 需求理解和澄清 | 需求澄清文档 | ✅ 用户确认 |
| 阶段2 | 需求文档编写 | 需求规格文档 | ⚠️ 质量≥70分 |
| 阶段3 | 需求验证 | 需求验证文档 | ✅ 质量≥90分 + 用户批准 |
...
- [ ] 已确认当前所处阶段？
- [ ] 已识别不确定的问题？
- [ ] 已理解快速流程 vs 完整流程的选择标准？
- [ ] 已准备好专业工具（5W2H、EARS、MoSCoW、RICE）？

**If 检查未通过**: **STOP**，先补充缺失的上下文信息。

**MUST DO**:
- 你 MUST 仔细阅读并理解所有相关需求文档
- 你 MUST 明确当前处于哪个阶段
- 你 MUST 识别所有不确定的地方

**NEVER DO**:
- NEVER 在没有理解上下文的情况下开始工作
- NEVER 假设你已经了解所有信息
- NEVER 跳过质量标准检查
