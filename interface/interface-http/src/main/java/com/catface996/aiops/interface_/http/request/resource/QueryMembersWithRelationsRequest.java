 ...
 * 查询成员及关系请求
 *
 * <p>用于 POST /resources/members-with-relations/query 接口</p>
 *
 * <p>需求追溯：</p>
 * <ul>
 *   <li>Feature 024: POST-Only API 重构</li>
 *   <li>原接口: GET /resources/{id}/members-with-relations</li>
 * </ul>
 *
 * @author AI Assistant
 * @since 2025-12-22
 */
@Schema(description = "查询成员及关系请求")
public class QueryMembersWithRelationsRequest {
    ...
    public QueryMembersWithRelationsRequest() {
    }

    public QueryMembersWithRelationsRequest(Long resourceId) {
