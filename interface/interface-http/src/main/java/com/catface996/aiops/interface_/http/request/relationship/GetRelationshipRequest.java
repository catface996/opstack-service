 ...
 * 获取单个关系请求
 *
 * <p>用于 POST /relationships/get 接口</p>
 *
 * <p>需求追溯：</p>
 * <ul>
 *   <li>Feature 024: POST-Only API 重构</li>
 *   <li>原接口: GET /relationships/{relationshipId}</li>
 * </ul>
 *
 * @author AI Assistant
 * @since 2025-12-22
 */
@Schema(description = "获取单个关系请求")
public class GetRelationshipRequest {
    ...
    public GetRelationshipRequest() {
    }

    public GetRelationshipRequest(Long relationshipId) {
